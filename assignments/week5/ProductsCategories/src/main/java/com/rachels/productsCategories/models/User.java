...
public class User {
	...
	public User(Long id,
			@NotBlank @NotEmpty(message = "Name is required") @Size(min = 3, max = 50, message = "Name must be between 3 and 30 characters!") String name,
			...
			@NotEmpty(message = "Password is required!") @Size(min = 8, max = 128, message = "Password must be between 8 and 128 characters!") String confirm) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
